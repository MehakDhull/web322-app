...
module.exports = {
  ...
  initialize: function () {
    return new Promise((resolve, reject) => {
      const db = mongoose.createConnection("mongodb+srv://mehakdhull189:HVrIhbwLBadw9C6e@mehak.ovrph.mongodb.net/users?retryWrites=true&w=majority&tls=true"); // Replace with your MongoDB connection string
